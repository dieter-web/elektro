function init() {
  ...
  cursor = svg.append("circle").attr("r", 10).attr("stroke", "black").attr("stroke-width", 1).attr("fill", "white").attr("transformation", "translate(-100, -100").attr("class", "cursor").on(".brush", brushed);
}
