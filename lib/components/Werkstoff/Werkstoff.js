...
class vLeiterwerkstoff extends vWerkstoff {
  ...
  fshape() {
    this.Symbol.select("#shape").attr("fill", this.vis.fill).attr("fill-opacity", this.data.fillopacity).attr("style", this.vis.style).append("rect").attr("x", this.point.x).attr("y", this.point.y).attr("height", this.vis.height).attr("width", this.vis.width);
...
export { vWerkstoff, vLeiterwerkstoff, vEisenwerkstoff, vBaustahl, vAutomatenstahl, vEinsatzstahl, vVerguetungsstahl, vWerkzeugstahl };