...
routerGet(router, R1.r1.toLowerCase(), R1.p, R1.l, R1.r1)

/** SECTION Elektrotechnik Gleichspannung Grundbegriffe */
routerGet(router, R1.r1_1.toLowerCase(), R1.p, R1.l, R1.r1_1)

/** SECTION Gleichspannung Grundbegriffe Temperaturkoeffizient */
routerGet(router, R1.r1_1_1.toLowerCase(), R1.p, R1.l, R1.r1_1_1)
...
routerGet(router, R1.r1_1_2.toLowerCase(), R1.p, R1.l, R1.r1_1_2)
...
routerGet(router, R1.r1_1_3.toLowerCase(), R1.p, R1.l, R1.r1_1_3)
